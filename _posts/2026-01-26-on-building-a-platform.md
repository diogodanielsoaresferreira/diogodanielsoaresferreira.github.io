...
Team members that have already build platforms from scratch can be the difference between building a useful platform or building an MVP that will have to be rebuilt once users start interacting with it. 
